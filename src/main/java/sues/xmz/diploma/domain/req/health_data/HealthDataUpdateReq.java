...
@Schema(description = "修改健康数据的请求参数")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class HealthDataUpdateReq implements Serializable {

    @Schema(description = "健康数据ID", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "健康数据ID不能为空")
