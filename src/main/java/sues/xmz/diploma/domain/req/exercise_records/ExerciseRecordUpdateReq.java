...
@Schema(description = "更新运动记录的信息")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class ExerciseRecordUpdateReq implements Serializable {

    @Schema(description = "运动记录ID", requiredMode = Schema.RequiredMode.REQUIRED)
